...
public class RangeWheelView extends View {
	...
	/** 当前值与标签文本颜色 */
	private static final int VALUE_TEXT_COLOR = 0x5500ff00;

	/** 项目文本颜色 */
	private static final int ITEMS_TEXT_COLOR = 0xFFff0000;
...
//		setBackgroundResource(R.drawable.wheel_bg);
	...
	private void drawValue(Canvas canvas) {
		valuePaint.setColor(VALUE_TEXT_COLOR);  //要加上透明色前两位
